...
if (!count) {
 ...
 add.run('Goal Arena Rama 9','\u0e1e\u0e23\u0e30\u0e23\u0e32\u0e21 9 \u00b7 2.3 \u0e01\u0e21.','\u0e16\u0e19\u0e19\u0e1e\u0e23\u0e30\u0e23\u0e32\u0e21 9 \u0e01\u0e23\u0e38\u0e07\u0e40\u0e17\u0e1e\u0e2f',4.8,1200,1,'5v5,7v7')
...
try {
 const repairs = [
  [1, 'Goal Arena Rama 9', '\u0e1e\u0e23\u0e30\u0e23\u0e32\u0e21 9 \u00b7 2.3 \u0e01\u0e21.', '\u0e16\u0e19\u0e19\u0e1e\u0e23\u0e30\u0e23\u0e32\u0e21 9 \u0e01\u0e23\u0e38\u0e07\u0e40\u0e17\u0e1e\u0e2f'],
  [2, 'SoccerPro Ladprao', '\u0e25\u0e32\u0e14\u0e1e\u0e23\u0e49\u0e32\u0e27 \u00b7 4.1 \u0e01\u0e21.', '\u0e25\u0e32\u0e14\u0e1e\u0e23\u0e49\u0e32\u0e27 \u0e01\u0e23\u0e38\u0e07\u0e40\u0e17\u0e1e\u0e2f'],
  [3, 'Kick Off Stadium', '\u0e23\u0e31\u0e0a\u0e14\u0e32 \u00b7 6.3 \u0e01\u0e21.', '\u0e23\u0e31\u0e0a\u0e14\u0e32 \u0e01\u0e23\u0e38\u0e07\u0e40\u0e17\u0e1e\u0e2f']
 ];
 const repair = db.prepare("UPDATE venues SET area=?, address=? WHERE id=? AND (area LIKE '%?%' OR address LIKE '%?%')");
 for (const [id, name, area, address] of repairs) repair.run(area, address, id);
} catch {}
