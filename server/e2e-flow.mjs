...
const host={name:`E2E Host ${stamp}`,email:`e2e-host-${stamp}@porsball.test`,password:'TestPass123!'}
const guest={name:`E2E Guest ${stamp}`,email:`e2e-guest-${stamp}@porsball.test`,password:'TestPass123!'}
let H,G
