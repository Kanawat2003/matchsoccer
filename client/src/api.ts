const API=`${window.location.protocol}//${window.location.hostname}:4001/api`
...
export type User={id:number;name:string;email:string;role:string;points:number;wins:number;losses:number}
